...
% Load file resulting from process_call_index_new
clear all; close all; load 'acoustic_data/MARS_SpectrumLevel_Daily_bySolarElevation.mat'
...
% textm(36.85,-121.78,'MB','fontsize',fs,'fontweight','bold');
...
axes('position',[0 0 1 1]); set(gca,'visible','off');%frame;
