...
clear all; close all; bi = imread('tag_data/blue_zoom.jpg'); 

%data for Figure 3b
deployment = 'bw170814-51';
load(['tag_data/CATS/',deployment,'/',deployment,' 10Hzprh.mat'])
...
% legend('Day','Night','Dusk/Dawn','Fontsize',9,'Position',[0.3173,0.3251,0.1467,0.1267]) 
